...
async function  getalbum() {
  ...
  // console.log(folder);
    let a=await fetch(`https://github.com/nikhild1111/Spotify/tree/main/songs`)
  ...
  for(let index=0;index<array.length;index++){
      ...
      let a2=await fetch(`https://github.com/nikhild1111/Spotify/tree/main/songs/${folder2}/info.json`)
...
async function  getsongs(folder) {
  // console.log(folder);
    let a=await fetch(`https://github.com/nikhild1111/Spotify/tree/main/songs/${folder}`)
